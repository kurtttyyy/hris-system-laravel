...
<script>
  ...
  function buildDoleExcelXml(employeeDetails) {
    ...
    const contractorRows = [1, 2, 3].map((index) => `
      <Row>
        <Cell ss:Index="2" ss:StyleID="doleSectionCell"><Data ss:Type="Number">${index}</Data></Cell>
        <Cell ss:MergeAcross="3" ss:StyleID="doleSectionCell"></Cell>
        <Cell ss:MergeAcross="2" ss:StyleID="doleSectionCell"></Cell>
        <Cell ss:MergeAcross="1" ss:StyleID="doleSectionCell"></Cell>
        <Cell ss:MergeAcross="2" ss:StyleID="doleSectionCell"></Cell>
      </Row>
    `).join('');
    const principalRows = [1, 2].map((index, rowIndex) => `
      <Row>
        <Cell ss:Index="2" ss:StyleID="${rowIndex === 1 ? 'doleNote' : 'doleSectionCell'}"><Data ss:Type="String">${rowIndex === 1 ? 'add separate sheet if needed' : ''}</Data></Cell>
    ...
    employeeDetails.forEach((employee, index) => {
      rows.push(`
        <Row>
          ...
          <Cell ss:StyleID="doleCellCenter"><Data ss:Type="String">${escapeExcelXml(employee.regularizationDate)}</Data></Cell>
