<header class="sticky top-0 z-40 border-b border-slate-200/80 bg-white/80 px-4 py-4 backdrop-blur-xl md:px-8 md:py-5">
    <div class="flex items-center justify-between gap-4 rounded-[1.75rem] border border-blue-100 bg-gradient-to-r from-white via-blue-50 to-white px-5 py-5 shadow-sm">
        <div>
            <p class="text-xs font-semibold uppercase tracking-[0.22em] text-blue-700">Leave Workspace</p>
            <h2 class="mt-2 text-3xl font-black tracking-tight text-slate-900">Leave Requests</h2>
            <p class="mt-1 text-sm text-slate-500">View and manage your leave applications</p>
        </div>

        <div class="flex items-center gap-2">
            <a href="{{ route('employee.employeeNotifications') }}" class="relative cursor-pointer rounded-2xl border border-blue-100 bg-white p-3.5 text-blue-700 transition hover:bg-blue-50" aria-label="Open notifications">
            ...
            <div class="relative group">
                <button class="flex h-11 w-11 items-center justify-center rounded-2xl border border-blue-100 bg-white text-blue-700 transition hover:bg-blue-50">
