        ...
        printWindow.document.write(`
            ...
            <head>
                ...
                <style>
                    ...
                    #leave-application-print-area section h5 {
                        font-size: 18px;
                        font-weight: 800;
                        letter-spacing: 0.4px;
                    ...
                    #leave-application-print-area .print-row-two {
                        margin-top: -4px !important;
                        margin-bottom: 4px !important;
                    }
                    #leave-application-print-area .print-row-two > div {
                        margin-top: 0 !important;
                        padding-top: 0 !important;
                    }
                    #leave-application-print-area .print-row-two label {
                        margin-top: -4px !important;
                        margin-bottom: 2px !important;
                    }
                    #leave-application-print-area .print-row-three {
                        margin-top: 4px !important;
                        margin-bottom: 4px !important;
                    }
                    #leave-application-print-area .print-row-three > div {
                        margin-top: 0 !important;
                        padding-top: 0 !important;
                    }
                    #leave-application-print-area .print-row-three label {
                        margin-top: 0px !important;
                        
                    }
                    #leave-application-print-area .print-action-two.mt-6 {
                        margin-top: 10px !important;
                        padding-top: 2px !important;
                    }
                    #leave-application-print-area .border-t.pt-5 {
                        padding-top: 0 !important;
                    }
                    #leave-application-print-area .leave-details-section {
                        margin-top: 8px !important;
                        padding-top: 0 !important;
                    }
                    #leave-application-print-area .action-details-section {
                        margin-top: 8px !important;
                        padding-top: 0 !important;
                    }
                    #leave-application-print-area .leave-details-section h5 {
                        margin-bottom: 2px !important;
                    }
                    #leave-application-print-area .leave-details-section .print-details-two {
                        margin-top: -4px !important;
                    }
                    #leave-application-print-area .leave-details-left {
                        gap: 0.35rem !important;
                    }
                    #leave-application-print-area .leave-details-left > div {
                        margin-top: 0 !important;
                        margin-bottom: 0 !important;
                    }
                    #leave-application-print-area .leave-details-left label {
                        margin-bottom: 2px !important;
                    }
                    #leave-application-print-area .sick-leave-section {
                        border-top: 0 !important;
                    }
                    #leave-application-print-area .leave-details-right {
                        gap: 0 !important;
                    }
                    #leave-application-print-area .leave-spent-group,
                    #leave-application-print-area .sick-leave-options {
                    ...
                    #leave-application-print-area .commutation-group {
                        margin-top: 0 !important;
                    }
                    #leave-application-print-area .applicant-signature-block {
                        padding-top: 0.75rem !important;
                    }
                    #leave-application-print-area .applicant-signature-block > div {
                        width: 55% !important;
                        max-width: 55% !important;
                    }
                    #leave-application-print-area .applicant-signature-block p {
                        margin-top: 0.25rem !important;
                    }
                    #leave-application-print-area .recommendation-disapprove-line {
                        margin-left: 5.9rem !important;
                    }
                    #leave-application-print-area .final-disapprove-line {
                        margin-left: 5.55rem !important;
                    }
                    #leave-application-print-area .leave-credits-block {
                        margin-top: 0 !important;
                    }
                    #leave-application-print-area .leave-credits-label {
                        margin-bottom: 0 !important;
                        line-height: 1.05 !important;
                    }
                    #leave-application-print-area .leave-credits-label input {
                        margin-top: 0.1rem !important;
                        padding-top: 0 !important;
                        padding-bottom: 0 !important;
                    }
                    #leave-application-print-area .leave-credits-table {
                        margin-top: 0.25rem !important;
                    }
                    #leave-application-print-area .leave-credits-table th,
                    #leave-application-print-area .leave-credits-table td {
                        padding-top: 0.1rem !important;
                        padding-bottom: 0.1rem !important;
                    }
                    #leave-application-print-area .recommendation-block {
                        gap: 0.55rem !important;
                    }
                    #leave-application-print-area .recommendation-block > div {
                        margin-top: 0.1rem !important;
                    }
                    #leave-application-print-area .recommendation-block .pt-10 {
                        padding-top: 1.1rem !important;
                    }
                    #leave-application-print-area .approved-for-block {
                        gap: 0.35rem !important;
                    }
                    #leave-application-print-area .approved-for-block > div {
                        gap: 0.45rem !important;
                        margin-top: 0 !important;
                    }
                    #leave-application-print-area .final-disapprove-block {
                        padding-top: 0.2rem !important;
                    }
                    #leave-application-print-area #days-with-pay-value,
                    #leave-application-print-area #days-without-pay-value {
                        min-width: 4.5rem !important;
                        font-size: 1rem !important;
                        line-height: 1.1 !important;
                    }
                    #leave-application-print-area .approved-for-others-line {
                        width: 4.5rem !important;
                        min-width: 4.5rem !important;
                    }
                    #leave-application-print-area label,
                    #leave-application-print-area p,
                    #leave-application-print-area span {
                        font-size: 1.05rem !important;
                    }
                    #leave-application-print-area table th,
                    #leave-application-print-area table td {
                        font-size: 0.98rem !important;
                    }
                    #leave-application-instructions .download-form-footer {
                    ...
                    #leave-application-instructions > p:first-child {
                        font-size: 1rem !important;
                    }
